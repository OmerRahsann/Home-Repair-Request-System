...
describe('PasswordStrength', () => {
  ...
  it('renders password requirements when password is filled', () => {
    ...
    expect(
      screen.getByText('✗ Password must be 8 to 64 characters'),
    ).toBeInTheDocument()
    expect(
      screen.getByText('✓ Password must have at least 1 uppercase letter'),
    ).toBeInTheDocument()
    expect(
      screen.getByText('✗ Password must have at least 1 number'),
    ).toBeInTheDocument()
  })
