...
describe('ServiceRequestForm', () => { 
  ...
  it('submits the form', async () => {
    ...
    // Fill in form inputs
    fireEvent.change(screen.getByPlaceholderText('ex: Gutter Cleanup'), { target: { value: 'Test Title' } });
    fireEvent.change(screen.getByPlaceholderText('ex: 250'), { target: { value: '100' } });
