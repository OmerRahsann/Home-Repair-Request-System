    ...
    return (
        ...
        <div className="bg-gradient-to-r from-[#000000]  w-full relative">
            ...
            >
                ...
                <h2 className="text-[1.5vw] font-bold pl-10 pt-5">To Create a Service Request:</h2>
                <p className="text-[1.2vw] pl-10 max-w-[40%] " >
                    simply tell us about the home repair or improvement project you need assistance with.
                    We'll match you with qualified service providers in your area who can help you get the job done. Whether it's a plumbing issue, electrical work, remodeling, or any other home-related task, our platform makes it easy to get started. Just provide the details, and we'll take care of the rest.
                </p>
